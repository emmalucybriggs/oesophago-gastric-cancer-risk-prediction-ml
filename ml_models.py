...
og_subs['age_group'].replace({'Under 55':0.0, '55 and over':1.0}, inplace=True)
og_subs['age_band'].replace({'Under 60':0.0, '60 and over':1.0}, inplace=True)
...
ages_scaled = min_max_scaler.fit_transform(og_subs[['age_at_dx']])
og_subs['age_at_dx'] = ages_scaled

#normalise cholesterol
min_max_scaler2 = preprocessing.MinMaxScaler()
chol_sq_scaled = min_max_scaler2.fit_transform(og_subs[['chol_sq']])
og_subs['chol_sq'] = chol_sq_scaled

#split into data and target
data = og_subs[feature_set]
target = og_subs[target_feature]
...
print("ROC score:", metrics.roc_auc_score(target_test, test_probas[:,1]))
print('')
...
print("ROC score:", metrics.roc_auc_score(target_test,test_probas2[:,1]))
print('')
...
f1_score = f1_score(target_test, predicted)
...
data_nb = og_subs[feature_set_nb]
target_nb = og_subs[target_feature]
...
print('')
print("Brier:", brier_score_loss(target_test, test_pred_xgb))
